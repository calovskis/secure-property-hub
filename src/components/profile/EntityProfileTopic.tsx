/**
 * Client profile topic: US holding entity ("company information").
 *
 * Mirrors the dashboard "Important tip": a foreign national is told that US
 * property is customarily held through an LLC or a trust and can
 *  - learn more (FAQ in a new tab),
 *  - register an entity they already hold, or
 *  - ask Loqal to structure and manage it (terms confirmed → entity manager).
 *
...
export function EntityProfileTopic() {
  ...
  return (
    <>
      <TopicCard
        title="Company information (US holding entity)"
        summary={summary}
        attention={missing}
      >
        {hasEntity ? (
          ...
          <div>
            <div className="flex items-start gap-2">
              ...
              <p className="text-sm leading-relaxed text-muted-foreground">
                In the United States it is standard industry practice to hold property assets
                through an entity — most often an LLC, sometimes a trust — rather than in a personal
                name. We recommend it to every Loqal client: it keeps liability with the property,
                makes US banking, taxes and future transfers straightforward, and keeps your name
                out of public records. Loqal can structure it properly for you.
              </p>
            </div>
        ...
        <DialogContent className="max-w-xl">
          ...
          <label className="mt-1 flex items-start gap-2 rounded-lg border border-border bg-muted/40 p-3 text-sm text-foreground">
            <input
              ...
              className="mt-0.5"
            />
            I confirm these terms and would like Loqal to set up and manage the holding structure
            for my purchase.
          </label>
          <button
            type="button"
