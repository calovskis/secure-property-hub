...
export const FAMILY_LABEL: Record<string, string> = {
  ...
  fha: "FHA (government-insured)",
  dscr: "DSCR (qualifies on rent)",
  "second-lien": "Second lien",
  "non-qm-alt-doc": "Non-QM alternative documentation",
  "itin-full-alt": "ITIN full / alt doc",
  "itin-dscr": "ITIN DSCR",
};
...
export const BANK_PROGRAMS: BankProgram[] = [
  ...
  },
  {
    ...
    source: "A&D Mortgage — Foreign National Full Doc matrix · Foreign National Product Matrix (08/28/2026)",
  },
  {
    id: "ad-fn-dscr",
    family: "fn-dscr",
    ...
    source: "A&D Mortgage — Foreign National DSCR matrix · Foreign National Product Matrix (08/28/2026)",
  },
  {
    ...
    source: "A&D Mortgage — Foreign National Asset Utilization matrix · Foreign National Product Matrix (08/28/2026)",
  },
  {
  ...
  /* ------------------------------------------------------ A&D — FHA & Non-QM */
  {
    ...
    family: "fha",
    track: "conventional",
    blurb: "Government-insured loan for the borrower's own home — from 3.5% down, credit score 580+.",
    occupancy: ["primary"],
    maxLoan: HIGH_BALANCE_LIMIT,
    maxPurchaseLtv: 96.5,
    minFico: 580,
    ...
    reservesMonths: 0,
    terms: [
      "Max LTV 96.5% with 580+ (manual underwrite 620+) · manufactured home 95% (620+)",
      "Loan amount per HUD county limit for the property location",
      "DTI and reserves evaluated by AUS",
      "Residency: US citizen and permanent resident",
      "Property: SFR, 2–4 units, FHA-approved condo, PUD, manufactured",
      "Owner-occupied only (a vacation home answered in the questionnaire is sorted here as primary)",
    ],
    guidelines: ["A&D FHA Overlays (01/26/2026)"],
    source: "A&D Mortgage — FHA Product Matrix (08/28/2026)",
  },
  {
    id: "ad-dscr",
    bank: "A&D Mortgage",
    ...
    family: "dscr",
    track: "conventional",
    blurb: "Investment loan qualified on the property's rent — no personal income used.",
    occupancy: ["investment"],
    minLoan: 75_000,
    maxLoan: 3_000_000,
    maxPurchaseLtv: 80,
    ...
    terms: [
      "Loan amount $75,000 – $3,000,000 · max CLTV 80% for 700+, lower by FICO",
      "DSCR below 1 requires FICO 680 · non-permanent residents min FICO 700",
      "Reserves: 3 months to $1M · 6 months to $2M · 12 months above",
      "Second appraisal above $2M · SFR, 2–4 units, warrantable/non-warrantable condo",
    ],
    guidelines: ["A&D Non-QM Loan Eligibility Guidelines (09/24/2026)", "A&D Non-QM Product Matrix (08/31/2026)"],
    source: "A&D Mortgage — DSCR Product Matrix (08/28/2026)",
  },
  {
    id: "ad-second-lien",
    bank: "A&D Mortgage",
    ...
    family: "second-lien",
    track: "conventional",
    blurb: "Closed-end second mortgage behind an existing first loan, $50,000 to $500,000.",
    occupancy: ["primary", "second", "investment"],
    minLoan: 50_000,
    maxLoan: 500_000,
    maxPurchaseLtv: 85,
    ...
    reservesMonths: 0,
    terms: [
      "Loan amount $50,000 – $500,000 (Iowa owner-occupied min $69,501) · max HCLTV 85%",
      "DTI: citizens and permanent residents 50% · non-permanent residents and foreign nationals 43%",
      "Full doc: max DTI 50% at CLTV ≤80%, 45% above · third-party residency letter required",
      "Loans ≤$250,000 may use AVM and property condition report",
    ],
    guidelines: ["A&D Non-QM 2nd Lien Guidelines (09/24/2026)"],
    source: "A&D Mortgage — Second Lien Product Matrix (08/28/2026)",
  },
  /* -------------------------------------------------- HomeXpress — Non-QM */
  {
    id: "homexpress-primex",
    bank: "HomeXpress Mortgage",
    program: "PrimeX",
    family: "non-qm-full-doc",
    track: "conventional",
    blurb: "Owner-occupied non-QM, $100,000 to $4M, credit score 660+.",
    occupancy: ["primary"],
    minLoan: 100_000,
    maxLoan: 4_000_000,
    maxPurchaseLtv: 90,
    ...
    reservesMonths: 3,
    terms: [
      "Owner-occupied · loan $100,000 – $4,000,000 · minimum equity $40,000",
      "US citizens; non-permanent residents max 85% LTV and $2M",
      "Min FICO 660 · reserves 3 months at LTV ≤80%",
    ],
    source: "HomeXpress Mortgage — PrimeX Program Description (09/11/2026)",
  },
  {
    id: "homexpress-corex",
    bank: "HomeXpress Mortgage",
    ...
    family: "non-qm-full-doc",
    track: "conventional",
    blurb: "Owner-occupied non-QM for lower scores — primary wage earner 600+.",
    occupancy: ["primary"],
    minLoan: 100_000,
    maxLoan: 3_000_000,
    maxPurchaseLtv: 85,
    ...
    reservesMonths: 0,
    terms: [
      "Owner-occupied · loan $100,000 – $3,000,000 · minimum equity $40,000",
      "US citizens; non-permanent residents max 85% LTV and $2M",
      "Min FICO 600 (primary wage earner) · no reserves at LTV ≤80%",
    ],
    source: "HomeXpress Mortgage — CoreX Program Description (09/11/2026)",
  },
  {
    id: "homexpress-premierx",
    bank: "HomeXpress Mortgage",
    program: "PremierX",
    family: "jumbo",
    track: "conventional",
    blurb: "Owner-occupied premium non-QM for strong credit, $400,000 to $3M.",
    occupancy: ["primary"],
    minLoan: 400_000,
    maxLoan: 3_000_000,
    maxPurchaseLtv: 90,
    ...
    reservesMonths: 6,
    terms: [
      "Owner-occupied · loan $400,000 – $3,000,000 · minimum equity $40,000",
      "Min FICO 720 · 6 months PITI reserves (cash-out cannot be used)",
      "US citizens and eligible residents",
    ],
    source: "HomeXpress Mortgage — PremierX Program Description (09/11/2026)",
  },
  {
    id: "homexpress-investorx",
    bank: "HomeXpress Mortgage",
    program: "InvestorX",
    family: "dscr",
    track: "conventional",
    blurb: "Non-owner-occupied investment loan (incl. DSCR), $100,000 to $2.5M.",
    occupancy: ["investment"],
    minLoan: 100_000,
    maxLoan: 2_500_000,
    maxPurchaseLtv: 80,
    ...
    reservesMonths: 0,
    terms: [
      "Non-owner-occupied only · loan $100,000 – $2,500,000 (DSCR below .75: $200,000 – $2,000,000)",
      "Min FICO 620 · minimum equity $40,000",
      "US citizens; foreign nationals on DSCR only, closing in a legal entity",
    ],
    source: "HomeXpress Mortgage — InvestorX Program Description (09/11/2026)",
  },
  {
    id: "homexpress-investorx-fn",
    bank: "HomeXpress Mortgage",
    program: "InvestorX — Foreign National DSCR",
    family: "fn-dscr",
    track: "foreign_national",
    blurb: "InvestorX DSCR for foreign nationals — must close in a legal entity (LLC).",
    occupancy: ["investment"],
    minLoan: 100_000,
    maxLoan: 2_500_000,
    maxPurchaseLtv: 70,
    ...
    reservesMonths: 0,
    terms: [
      "Foreign nationals: DSCR only, closing in a legal entity",
      "Loan $100,000 – $2,500,000 · minimum equity $40,000",
      "LTV and reserves per the InvestorX program description",
    ],
    source: "HomeXpress Mortgage — InvestorX Program Description (09/11/2026)",
  },
  /* ------------------------------------------------ Champions — Non-QM & ITIN */
  {
    id: "champions-accelerator-activator-alt",
    bank: "Champions Funding",
    program: "Accelerator / Activator — Alt Doc",
    family: "non-qm-alt-doc",
    track: "conventional",
    blurb: "Bank statement, P&L, WVOE, 1099 or asset utilization income, $150,000 to $3M.",
    occupancy: ["primary", "second", "investment"],
    minLoan: 150_000,
    maxLoan: 3_000_000,
    maxPurchaseLtv: 85,
    ...
    terms: [
      "Loan $150,000 – $3,000,000 · income by bank statement, P&L, WVOE (min 680), 1099 or assets",
      "DTI max 50% · 55% with $3,000 residual income · 45% when LTV above 80%",
      "Cash in hand: $1M above 65% LTV, unlimited at or below · cash-out can cover reserves",
      "Interest-only: max 75% LTV $2M–$2.5M, 70% above · 2 appraisals from $2M",
    ],
    source: "Champions Funding — Accelerator / Activator Alt Doc matrix",
  },
  {
    id: "champions-accelerator-dscr-1-4",
    bank: "Champions Funding",
    program: "Accelerator DSCR (1–4 units)",
    family: "dscr",
    track: "conventional",
    blurb: "Business-purpose DSCR for 1–4 unit rentals, $100,000 to $3M, including no-ratio.",
    occupancy: ["investment"],
    minLoan: 100_000,
    maxLoan: 3_000_000,
    maxPurchaseLtv: 80,
    ...
    reservesMonths: 0,
    terms: [
      "Loan $100,000 – $3,000,000 · below $150,000 max 75% purchase, 70% cash-out",
      "DSCR ≥1.00: up to 80% (700+) · DSCR .75–.99: up to 80% (720+) · no ratio below .75: min FICO 680–720, max 75%",
      "Tradelines: 1 open 24 months or 2 open 12 months · 2 appraisals from $2M",
    ],
    source: "Champions Funding — Accelerator DSCR 1–4 Unit matrix",
  },
  {
    id: "champions-accelerator-dscr-5-8",
    bank: "Champions Funding",
    program: "Accelerator DSCR (5–8 units)",
    family: "dscr",
    track: "conventional",
    blurb: "Small multifamily 5–8 units, DSCR at least 1.00, $400,000 to $2M.",
    occupancy: ["investment"],
    minLoan: 400_000,
    maxLoan: 2_000_000,
    maxPurchaseLtv: 75,
    ...
    reservesMonths: 0,
    terms: [
      "5–8 unit properties · loan $400,000 – $2,000,000 · minimum DSCR 1.00",
      "Max 75% purchase · 70% rate & term · 65% cash-out",
      "US citizen, permanent resident, non-permanent resident with US credit and acceptable visa",
    ],
    source: "Champions Funding — Accelerator DSCR 5–8 Unit matrix",
  },
  {
    id: "champions-dscr-equity-first",
    bank: "Champions Funding",
    program: "DSCR Equity First",
    family: "dscr",
    track: "conventional",
    blurb: "Low-leverage DSCR (max 55% LTV), no minimum FICO, no reserves.",
    occupancy: ["investment"],
    minLoan: 125_000,
    maxLoan: 1_500_000,
    maxPurchaseLtv: 55,
    ...
    reservesMonths: 0,
    terms: [
      "Loan $125,000 – $1,500,000 · max LTV/CLTV 55%",
      "No minimum FICO / no FICO required · no reserves",
      "Remaining equity (value minus loan) must be at least $150,000",
    ],
    source: "Champions Funding — DSCR Equity First matrix",
  },
  {
    id: "champions-itin-activator",
    bank: "Champions Funding",
    program: "ITIN Activator — Full / Alt Doc",
    family: "itin-full-alt",
    track: "itin",
    blurb: "Primary and second home for ITIN borrowers, $100,000 to $1M, no FICO allowed.",
    ...
    reservesMonths: 0,
    terms: [
      "ITIN borrowers · loan $100,000 – $1,000,000 · max LTV/CLTV 80% (70% cash-out)",
      "85% on purchase/rate & term with FICO 720, DTI 45% and 3x12 or 2x24 tradelines",
      "No FICO accepted · qualifying FICO is the primary wage earner's mid-score · DTI max 50%",
      "Income: full doc, bank statement, P&L, WVOE (min 680 FICO), 1099 or assets",
    ],
    source: "Champions Funding — ITIN Activator Alt Doc matrix",
  },
  {
    id: "champions-itin-dscr",
    bank: "Champions Funding",
    program: "ITIN Accelerator DSCR (1–4 units)",
    family: "itin-dscr",
    track: "itin",
    blurb: "Rental property loan for ITIN borrowers on DSCR of .80 or more, $100,000 to $1M.",
    occupancy: ["investment"],
    minLoan: 100_000,
    maxLoan: 1_000_000,
    maxPurchaseLtv: 75,
    ...
    reservesMonths: 6,
    terms: [
      "ITIN borrowers · loan $100,000 – $1,000,000 · DSCR ≥ .80",
      "No FICO allowed at 70% LTV, max loan $750,000",
      "6 months reserves · tradeline 1x24 with activity in the last 90 days",
    ],
    source: "Champions Funding — ITIN DSCR matrix",
  },
  {
    id: "champions-fn-ambassador-dscr",
    bank: "Champions Funding",
    program: "Ambassador DSCR — Foreign National (1–4 units)",
    family: "fn-dscr",
    track: "foreign_national",
    blurb: "Foreign national DSCR, $125,000 to $3M, foreign credit accepted, first-time investors allowed.",
    occupancy: ["investment"],
    minLoan: 125_000,
    maxLoan: 3_000_000,
    maxPurchaseLtv: 70,
    ...
    creditEventMonths: 36,
    terms: [
      "Loan $125,000 – $3,000,000 · foreign credit up to 60% · US credit 680–720+ for higher LTV",
      "DSCR ≥1.00, .75–.99 and no-ratio options · 2 appraisals from $2M",
      "First-time investors permitted (no US rental ownership in 36 months)",
      "Credit events seasoned more than 36 months",
    ],
    source: "Champions Funding — FN Ambassador DSCR matrix",
  },
  /* ------------------------------------------------------- Newrez — Smart */
  {
    id: "newrez-smartvest",
    bank: "Newrez",
    bankNmls: "3013",
    program: "SmartVest Platinum",
    family: "dscr",
    track: "conventional",
    blurb: "Business-purpose investment loan (long-term and short-term rental), manually underwritten.",
    occupancy: ["investment"],
    minLoan: 75_000,
    maxLoan: 2_000_000,
    maxPurchaseLtv: 80,
    ...
    reservesMonths: 0,
    terms: [
      "1–4 units · up to 80% to $1M (680+) · 75% to $1.5M (720+) · 70% to $2M (720+)",
      "First-time investor min credit score 680 · all loans manually underwritten",
      "Permanent residents eligible; non-permanent residents ineligible",
      "State minimum loan amounts apply (e.g. NC >$100,000, SC >$810,000)",
    ],
    guidelines: ["Newrez Smart Series Summary & Guideline Updates (08/17/2026)"],
    source: "Newrez — SmartVest Platinum Product Summary",
  },
  {
    id: "newrez-smartself",
    bank: "Newrez",
    ...
    family: "non-qm-alt-doc",
    track: "conventional",
    blurb: "Self-employed loan on bank statements, 1099 or P&L — up to 90% LTV, $3.5M.",
    occupancy: ["primary", "second", "investment"],
    maxLoan: 3_500_000,
    maxPurchaseLtv: 90,
    tiers: [
      { upTo: 1_500_000, purchaseLtv: 90 },
      { upTo: 3_000_000, purchaseLtv: 75 },
      { upTo: 3_500_000, purchaseLtv: 70 },
    ],
    minFico: 640,
    noScoreAllowed: false,
    reservesMonths: 0,
    terms: [
      "Purchase: 90% to $1.5M (720+) · 75% to $3M (740+) · 70% to $3.5M (740+)",
      "Non-permanent residents: min FICO 700, max loan $2M",
      "Manually underwritten · DTI above 45% needs 3 extra months of reserves",
    ],
    guidelines: ["Newrez Smart Series Summary & Guideline Updates (08/17/2026)"],
    source: "Newrez — SmartSelf Product Summary",
  },
  {
    id: "newrez-smartedge",
    bank: "Newrez",
    ...
    family: "non-qm-full-doc",
    track: "conventional",
    blurb: "Full-doc non-QM for borrowers just outside agency rules — up to 90% LTV, $3.5M.",
    occupancy: ["primary", "second", "investment"],
    maxLoan: 3_500_000,
    maxPurchaseLtv: 90,
    tiers: [
    ...
    reservesMonths: 0,
    terms: [
      "Purchase 1–4 units: 90% to $1.5M (720+) · 75% to $3M (740+) · 70% to $3.5M (740+)",
      "Non-permanent residents: min FICO 700, max loan $2M · cash-out max 75%",
      "Manually underwritten",
    ],
    guidelines: ["Newrez Smart Series Summary & Guideline Updates (08/17/2026)"],
    source: "Newrez — SmartEdge Product Summary",
  },
];
